...
import com.example.namespace.databinding.ActivityAddPostBinding;
...
public class AddPostActivity extends AppCompatActivity {
    ...
    private ActivityAddPostBinding ui;
    private Bitmap bitmap = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ui = ActivityAddPostBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        btnPost = ui.btnReadPost;
        imgPost = ui.imgAddPost;
        txtDesc = ui.txtseachpost;
        ...
        StringRequest request =new StringRequest(Request.Method.POST,Constant.ADD_POST,response -> {
            try {
                ...
                if(object.getBoolean("success")){
                    ...
                    Toast.makeText(this, "putted", Toast.LENGTH_SHORT).show();
                    finish();
